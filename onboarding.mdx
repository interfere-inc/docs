...
Create your workspace: a name, a URL (your slug, such as `interfere.com/~/acme`), your company email domain, and a [data residency](#data-residency) region.
...
Set up your first [surface](/concepts#surface), the app Interfere will watch:
...
See [Integrations](/integrations/overview) for what each provider does.
