...
<Steps>
  ...
  <Step title="Deploy">
    Ship your app. Once it's running, events start flowing and your first problems appear in the dashboard, already grouped and triaged. Trigger an error to confirm the whole path end to end.
  </Step>
</Steps>
