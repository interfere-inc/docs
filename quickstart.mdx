...
<AccordionGroup>
  ...
  <Accordion title="Telemetry blocked by an ad-blocker">
    Some ad-blockers drop requests to telemetry endpoints. Set `apiHost` on the SDK to a subdomain of your own site — a CNAME to the target shown in your dashboard — so telemetry posts to your own origin. See the [Next.js](/sdk/next-js#custom-ingest-domain) or [Vite](/sdk/vite#custom-ingest-domain) SDK guides.
  </Accordion>
</AccordionGroup>
