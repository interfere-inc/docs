...
<CardGroup cols={3}>
  <Card title="Vite + React" icon="/icons/tech/vite/original.svg">
    `@interfere/vite`: a Vite plugin plus `init()` before render. Works for SPA and SSR.
  </Card>

<Card title="TanStack Start" icon="/icons/tech/tanstack/original.svg">
  `@interfere/vite`: the same plugin, with a server route for proxying.
</Card>

  <Card title="NestJS" icon="/icons/tech/nestjs/original.svg">
